   ...
   */
   public static void main (String [] args)
   {
     ...
     /* problem initialization */
      ...
      Ordinary [] ord = new Ordinary [SimulConsts.M-1];                 // array of ordinary threads
      ...
      for (int i = 0; i < SimulConsts.M-1; i++)
        ord[i] = new Ordinary("ord "+(i+1), i, apStub, csStub, ccsStub, museumStub, reposStub);
     ...
     /* waiting for the end of the simulation */
      ...
      { try
        ...
        GenericIO.writelnString ("The ordinary " + (i+1) + " has terminated.");
      }
      ...
      { GenericIO.writelnString ("ordinary generator remote exception on AssaultParty0 shutdown: " + e.getMessage ());
        System.exit (1);
      }
      try
      { apStub[1].shutdown ();
      ...
      { GenericIO.writelnString ("ordinary generator remote exception on AssaultParty1 shutdown: " + e.getMessage ());
        System.exit (1);
      }
      ...
      { GenericIO.writelnString ("ordinary generator remote exception on ConcentrationSite shutdown: " + e.getMessage ());
        System.exit (1);
      }
      ...
      { GenericIO.writelnString ("ordinary generator remote exception on ControlCollectionSite shutdown: " + e.getMessage ());
        System.exit (1);
      }
      ...
      { GenericIO.writelnString ("ordinary generator remote exception on Museum shutdown: " + e.getMessage ());
        System.exit (1);
      }
