...
public class ServerAssaultParty {
   ...
   */
    ...
    *        args[3] - number of the assault party
    */
    public static void main (String[] args)
    {
       ...
       String partyNumber = "";					      //Party number of the assaultParty
       partyNumber = args[3];
      ...
      /* instantiate a Assault Party object */
       ...
       AssaultParty ap = new AssaultParty (reposStub);      //Assault Party object
       AssaultPartyInterface apStub = null;                 // remote reference to the Assault Party object
 
       try
       { apStub = (AssaultPartyInterface) UnicastRemoteObject.exportObject (ap, portNumb);
       }
       catch (RemoteException e)
       { GenericIO.writelnString ("Assault Party stub generation exception: " + e.getMessage ());
         e.printStackTrace ();
         System.exit (1);
       }
      ...
      /* register it with the general registry service */
       ...
       String nameEntryObject = "AssaultParty" + partyNumber;  // public name of the Assault Party object
       ...
       { GenericIO.writelnString ("AssaultParty"+ partyNumber+ " registration exception: " + e.getMessage ());
         e.printStackTrace ();
         System.exit (1);
       }
       catch (AlreadyBoundException e)
       { GenericIO.writelnString ("AssaultParty"+ partyNumber+ " already bound exception: " + e.getMessage ());
         e.printStackTrace ();
         System.exit (1);
       }
       GenericIO.writelnString ("AssaultParty"+ partyNumber+ " object was registered!");
 
      /* wait for the end of operations */
 
       GenericIO.writelnString ("AssaultParty"+ partyNumber+ " is in operation!");
       try
       { while (!end)
      ...
      /* server shutdown */
       ...
       GenericIO.writelnString ("AssaultParty"+ partyNumber+ " was deregistered!");
       ...
       if (shutdownDone)
          GenericIO.writelnString ("AssaultParty"+ partyNumber+ " was shutdown!");
    }
